...
var photoSchema = new mongoose.Schema({
    ...
    specifyPermit: {type: Boolean, default: false}, // determine if the user specifies the permission
    permission: [mongoose.Schema.Types.ObjectId],    // Array of user ids that can see the photo
    likeUsers: [mongoose.Schema.Types.ObjectId] // Array of user ids who "like" the photo
});
